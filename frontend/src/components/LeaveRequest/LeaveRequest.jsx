            ...
            <div className={`${styles.subdiv}`}>
                <form className={`${styles.subform}`}>
                    ...
                    <div>
                        <label >Remark:</label>
                        <br></br>
                        <input type="text" placeholder="Enter Remark" name="remark" onChange={(e)=>setRemark(e.target.value)}></input>
                    </div>
                    <div>
                    ...
                    <div className={`${styles.radiosel}`}>
                        ...
                        <div>
                            ...
                            <input type="radio" id="choice" name="choice2" value="No" defaultChecked={true}/>No
                        </div>
                    </div>
                    <div className={`${styles.radiosel}`}>
                        ...
                        <div>
                            ...
                            <input type="radio" id="choice" name="choice3" value="No" defaultChecked={true}/>No
                        </div>
                    </div>
